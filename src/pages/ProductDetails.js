...
const ProductDetails = () => {
  ...
  // get the single produvt base on yhe id 
  ...
  return <section className=' pt-32 pb-12 lg:py-32  h-screen flex items-center'>
    ...
    <div className="flex flex-col lg:flex-row items-center">
      ...
      <div className='flex-1 text-center lg:text-left'>
            ...
            <div className='text-x1 text-red-500 font-medium mb-6'>${price}</div>
            <p className='mb-8'>{description}</p>
            <button onClick={() => addToCart(product, product.id)} className='bg-primary py-4 px-8 text-white'>Add To Cartok</button>
      </div>
      </div>
    </div>
