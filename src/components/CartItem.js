      ...
      <div className='w-full min-h[150px] flex items-center gap-x-4'>
        ...
        <div className="flex flex-col w-full">
          ...
          <div className= 'flex gap-x-2 h-[36px] text-sm'>
            {/* qty */}
            <div className='flex flex-1 max-w-[100px] item-center h-full border text-primary font-medium'>
              {/*minus icon  */}
              <div  onClick={()=> decreaseAmount(id) } className='flex-1  flex justify-center items-center cursor-pointer'>
                <IoMdRemove />
              </div>
              {/* amount */}
              <div className=' h-full text-center justify-center items-center px-2'>{amount}</div>
              {/*plus icon  */}
